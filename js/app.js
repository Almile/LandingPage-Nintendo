...
function toggleMenu() {
    ...
    // Alterna o ícone com base no estado do menu
    if (navLinks.classList.contains("show")) {
        menuIcon.setAttribute("name", "close-outline"); // Ícone "X" quando aberto
    } else {
        menuIcon.setAttribute("name", "menu-outline"); // Ícone de menu quando fechado
    }
}
...
function openModalLogin() {
    document.getElementById("modalLogin").classList.add("showModal");
    console.log('modal aberto')
}

function closeModalLogin() {
    document.getElementById("modalLogin").classList.remove("showModal");
}
